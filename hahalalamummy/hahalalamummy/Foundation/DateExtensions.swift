...
public extension Date {
    ...
    /// SwifterSwift: dayOfWeek.
    ///
    ///     Date().dayOfWeek -> 5 // fifth day in the current week.
    ///
    ///     Sunday = 1 in default
    ...
    ///
    ///        Date().timeInterval -> 1484233862.826291
    ///
...
public extension Date {
    ...
    ///
    ///     let date = Date(timeInterval: 1484239783.922743) // "Jan 12, 2017, 7:49 PM"
    ///
